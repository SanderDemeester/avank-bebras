...
with one of the four categories (Ewok, Wookie, Padawan and Jedi) and a difficulty level (easy, medium and 
hard). After he selects a quiz, he is directed to a web page with a `start' button. Pressing that button 
