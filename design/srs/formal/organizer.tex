\begin{section}{Organizers}
	...
	\begin{subsection}{Manage Teachers}
        ...
        On the Add Teacher page is also a form available for upgrading students
        to teachers.
	\end{subsection}
	...
	\begin{subsection}{Manage Competitions}
		...
		\begin{subsubsection}{History}
			...
			without the countdown and progressbar. There's also a recycle link
            avaible, which can be used for instance to downgrade a passed
            official competition to an unrestricted contest. Because the
            competition should remain linked with the students who participated,
            a new ID is created for the recycled competition.
		\end{subsubsection}
