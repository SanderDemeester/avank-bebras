...
When creating a new organizer, the administrator can also pick a Teacher or
Pupil/Independent account to upgrade.
...
Admins have the ability to create other admins. However, there's only one
default admin initially. He can create these admins with a normal form, to
create a completely new account, or he can upgrade an organizer.
